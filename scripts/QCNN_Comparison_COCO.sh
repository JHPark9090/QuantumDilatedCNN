...
#SBATCH --output=/pscratch/sd/j/junghoon/QuantumDilatedCNN_Analysis/results/coco/QCNN_Comparison_COCO_%j.out
#SBATCH -e /pscratch/sd/j/junghoon/QuantumDilatedCNN_Analysis/results/coco/QCNN_Comparison_COCO_%j.err
...
mkdir -p /pscratch/sd/j/junghoon/QuantumDilatedCNN_Analysis/results/coco
mkdir -p /pscratch/sd/j/junghoon/QuantumDilatedCNN_Analysis/results/coco/checkpoints
...
python /pscratch/sd/j/junghoon/QuantumDilatedCNN_Analysis/scripts/QCNN_Comparison.py \
    ...
    --patience=10 \
    --resume \
    --output-dir='/pscratch/sd/j/junghoon/QuantumDilatedCNN_Analysis/results/coco' \
